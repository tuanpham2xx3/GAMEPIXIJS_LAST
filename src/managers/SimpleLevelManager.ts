...
import { SimpleFormationManager } from './SimpleFormationManager';

export class SimpleLevelManager {
    private enemyManager: EnemyManager;
    private formationManager: SimpleFormationManager;
    private currentLevel: number = 0;
    private isLevelActive: boolean = false;

    constructor(enemyManager: EnemyManager) {
        this.enemyManager = enemyManager;
        this.formationManager = new SimpleFormationManager(enemyManager);
